...
import { ListTaskComponent } from './compoenets/list-task/list-task.component';
...
export const routes: Routes = [
  ...
  { path: 'tasks', loadComponent: () => import('./compoenets/list-task/list-task.component').then(m => m.ListTaskComponent) },
